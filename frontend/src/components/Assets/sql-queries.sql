...
INSERT INTO thread VALUES (DEFAULT,8,'React technology','A discussion of the new version of React: 18, that was just added to NPM.',1,DEFAULT);
INSERT INTO thread VALUES (DEFAULT,1,'Out of Date','What is a severely out-of-date technology youre still forced to use regularly?',1,DEFAULT);
INSERT INTO thread VALUES (DEFAULT,1,'Hearing Loss','Scientists Develop a Technology That Reverses Hearing Loss',1,DEFAULT);
INSERT INTO thread VALUES (DEFAULT,1,'Suspend Tech','Taiwan says they have no current plans to suspend technology cooperation with Russia',1,DEFAULT);
