CREATE TABLE role (role_id serial PRIMARY KEY, role_name VARCHAR(15));
CREATE TABLE users (user_id serial PRIMARY KEY, username varchar(25),password varchar(30), email varchar(30),role_id int DEFAULT 1,register_date TIMESTAMP DEFAULT CURRENT_DATE,last_login TIMESTAMP DEFAULT CURRENT_DATE, CONSTRAINT fk_role_ID FOREIGN KEY(role_id) REFERENCES role(role_id));
...
INSERT INTO users VALUES (DEFAULT,'Plebian','SADJLFAIMSCIMASE','Evara@gmail.com');
--insert categories
